        ...
        <ul class="grid" style="grid-auto-rows: auto;">
            <li class="overflow-hidden pb-4 mb-4 border-b-2 border-screen" v-for="tweet in onDisplay">
                <div class="markup grid gap-padding" style="grid-auto-rows: auto">
                    ...
                    <div v-if="tweet.hasQuote" class="py-2 pl-2 text-xs text-dimmed border-l-2 border-screen" v-html="tweet.quote.html"></div>
                </div>
            </li>
        </ul>
    </tile>
...
<script>
    import echo from 'boarrd-base/mixins/echo';
    import Avatar from 'boarrd-base/atoms/Avatar';
    import Tile from 'boarrd-base/atoms/Tile';
    import RelativeDate from 'boarrd-base/atoms/RelativeDate';
    import Tweet from '../helpers/Tweet';
    import moment from 'moment';
    import {
        diffInSeconds
    } from 'boarrd-base/helpers';
